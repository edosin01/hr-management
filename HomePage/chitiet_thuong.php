<?php
    ...
    if(isset($_GET['update'])) {
        ...
        $sql = "SELECT * FROM khenthuong where ID_KhenThuong = '$id'";
...
<html lang="en">
  <head>
    ...
    <title>Chi tiết khen thưởng</title>
      ...
      <div id="content">
        ...
        <nav class="navbar tieude">
          <div class="container-fluid">
            <a class="navbar-brand clwhite navbar-title">Chi tiết khen thưởng</a>
        ...
        <!-- Begin: Form sửa khen thưởng -->
        <div class="row">
            <div class="col-md-12">
                <div class="row filter form-add">
                    <div class="col-sm-12">
                        <h4 class="form-add-title">Thông tin chi tiết khen thưởng</h4>
                        <div class="form-add-content">
                            <form class="row" method="POST" action="../Controller/sua_thuong.php" enctype="multipart/form-data">
                                <div class="form-group col-md-3">
                                  <label class="control-label">ID khen thưởng</label>
                                  <?php echo "<input readonly='true' name='id' class='form-control' type='text' value='" .$row['ID_KhenThuong'] ."'>"; ?>
                                </div>
                                <div class="form-group col-md-3">
                                  <label class="control-label">Tiền thưởng</label>
                                  <?php echo "<input name='money' class='form-control' type='text' required='' value='" .$row['tienThuong'] ."'>"; ?>
                                </div>
