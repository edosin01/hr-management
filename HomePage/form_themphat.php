      ...
      <div id="content">
        ...
        <nav class="navbar tieude">
          <div class="container-fluid">
            <a class="navbar-brand clwhite navbar-title">Thêm kỷ luật</a>
        ...
        <!-- Begin: Form thêm kỷ luật -->
        <div class="row">
            <div class="col-md-12">
                <div class="row filter form-add">
                    <div class="col-sm-12">
                        <h4 class="form-add-title">Kỷ luật</h4>
                        <div class="form-add-content">
                            <form class="row" method="POST" action="../Controller/add_phat.php" enctype="multipart/form-data">
