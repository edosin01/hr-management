      ...
      <div id="content">
        ...
        <nav class="navbar tieude">
          <div class="container-fluid">
            <a class="navbar-brand clwhite navbar-title">Thêm phòng ban mới</a>
        ...
        <!-- Begin: Form thêm phòng ban -->
        <div class="row">
            <div class="col-md-12">
                <div class="row filter form-add">
                    <div class="col-sm-12">
                        <h4 class="form-add-title">Tạo phòng ban mới</h4>
                        <div class="form-add-content">
                            <form class="row" method="POST" action="../Controller/add_pb.php" enctype="multipart/form-data">
                                ...
                                <div class="form-group col-md-3">
                                  <label class="control-label">Mã trưởng phòng</label>
                                  <select name="leader" class="form-control" id="exampleSelect2" required="">
                                    ...
                                    <?php
                                      ...
                                      while ($row = mysqli_fetch_assoc($result_matp)) {
                                        echo "<option value=" . $row['maNV'] .">". $row['maNV'] . " - ". $row['tenNV']."</option>";
                                      }
                                    ?>
                                  </select>
                                </div>
                                <div class="form-group col-md-3">
                                  <label class="control-label">Điện thoại phòng ban</label>
